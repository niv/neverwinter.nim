...
public:
	...
	//
	//          0:  Generates byte-code, suitable to be read by the script
	//              routine.
	//          1:  Generates "symbolic output", translating the output of
	//              the compiler into a programmer-readable format, assuming
	...
	// nValue:  (IN) A value to determine the type of output.
	//
	//          0:  Does not attempt to optimize the size of the script
	//              file by removing calls to functions that couldn't
	//              possibly be called by any routine.  Useful when
	//              comparing the symbolic output to the byte code
	//              generated.
	//
	//          1:  Removes functions that could not possibly be called
	//              by any routine.  This will not generate functions
	//              in the same location as portrayed by the symbolic
	//              output ... if you have many "uncalled" functions,
	//              it could also be significantly shorter than you expect.
	//
	///////////////////////////////////////////////////////////////////////
...
private:
	...
	int32_t ParseCharacterAtSign(int32_t chNext);
	...
	// Miscellaneous compilation directives.
